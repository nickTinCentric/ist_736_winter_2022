'''
  ...
  The outputs of the program are the averages of each month across the years
    ...
    MODIFIED BY ALFRED NICK TINSLEY 2-10-22 ## Added If statement to line 37 to filter out years greater than 2000
'''
...
with open(infile, 'rU') as csvfile:
    ...
    for line in priceReader:
      ...
      if line[0] == '' or line[0].startswith('Price') or line[0].startswith('Year'):
          ...
          try:
            ### MY MODIFICATION, I ADDED AN IF STATEMENT TO MAKE SURE THE YEAR WAS NOT GREATER THAN 2000
            if line[0] <= '2000':
